...
#Original
set.seed(346)
Modelo2<-randomForest(V18~V1+V2+V3+V4+V5+V6+V7+V8+V9+V10+V15+NL1+NL2+NL3+NL4+NV1+NV2+NV3,data=training_set,importance=TRUE,ntree=1000)
...
library(e1071)
mod_svm<-svm(V18~V1+V2+V3+V4+V5+V6+V7+V8+V9+V10+V11+NL1+NL2+NL3+NL4+NV1+NV2+NV3,data=training_set,kernel='radial', cost=10, cross=2, scale=FALSE) 
summary(mod_svm)
